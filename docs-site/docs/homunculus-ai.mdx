...
enabling or disabling mods, and even starting over from a fresh install all
leave `AI/USER_AI/` as you left it. To remove AzzyAI, delete its files from
`AI/USER_AI/`, or just stop typing `/hoai`.
